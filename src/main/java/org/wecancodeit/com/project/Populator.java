...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Continent northAmerica = new Continent("North America","North America is a continent in the Northern" +
                ...
                "Caribbean Sea, and to the west and south by the Pacific Ocean","../images/NorthAmericaContinent.jpg");
        Continent southAmerica = new Continent("South America", "South America is a continent entirely in the" +
                ...
                " in the Northern Hemisphere. ","../images/South America Continent.jpg");
        ...
        Continent asia = new Continent("Asia","Earth's largest and most populous continent located primarily in the " +
                ...
                " on the south by the Indian Ocean, and on the north by the Arctic Ocean. ", "../images/Asia continent.jpg");
        Continent oceania = new Continent("Oceania","Oceania is the smallest in land area and the second smallest " +
                "in population after Antarctica.It also spans the eastern and western Hemispheres","../images/Oceania-.jpg");
        ...
        Waterway atlanticOcean = new Waterway("Atlantic Ocean","The Atlantic Ocean is the" +
                ...
                " of Earth's surface ","../images/Atlantic Ocean.jpg");
        ...
        Waterway balticSea = new Waterway("Baltic Sea","The Baltic Sea is an arm of the Atlantic" +
                ...
                " Sweden and the North and Central European Plain.","../images/BalticSea.jpg");
        Waterway northSea = new Waterway("North Sea","The North Sea is a sea of the Atlantic Ocean between" +
                ...
                " through the English Channel in the south and the Norwegian Sea in the north.","../images/BeringSea.jpg");
        ...
        Waterway gulfOfThailand = new Waterway("Gulf of Thailand","The Gulf of Thailand, also known as the Gulf of Siam, " +
                ...
                " of the Indochinese Peninsula and the northern half of the Malay Peninsula","../images/GulfOfThailand.jpg");
        Waterway bacuitBay = new Waterway("Bacuit Bay","description","../images/BacuitBay.jpg");
        Waterway southernPacificOcean = new Waterway("Southern Pacific Ocean","The Pacific Ocean is divided into " +
                ...
                "the southern Pacific Ocean.","../images/SouthPacificOcean.jpg");
        ...
        Island bornholm = new Island("Bornholm Falster Lolland", "description","../images/Bornholm Island.jpg", balticSea);
        ...
        Island westcoast = new Island("West Coast Islands","description","../images/West Coast.jpg", gulfOfThailand);
        Island southernIslands = new Island("Southern Islands","description","../images/Southern Islands.jpg", gulfOfThailand);
        Island bacuitGroup = new Island("Bacuit Group of Islands","description","../images/Bacuit Islands.jpg", bacuitBay);
        Island hawaii = new Island("Hawaii", "Hawaiian Islands are an archipelago of eight major islands, several atolls, numerous" +
                ...
                " The Pineapple Isle, The Forbidden Isle, The Target Isle", "../images/Hawaii Islands.jpg", pacificOcean);
        ...
        Country unitedStates = new Country("United States", "The United States of America is the world's" +
                ...
                "the Pacific Ocean and to the east by the Atlantic Ocean. ", "../images/America-.jpg", northAmerica, seaIslandsChain);
        Country britain = new Country("Britain","Great Britain is an island in the North" +
                ...
                " a maritime climate with narrow temperature differences between seasons. ","../images/Britian.jpg", europe);
        Country chile = new Country("Chile", "Chile, officially the Republic of Chile,[b] is a country " +
                ...
                "the Andes to the east and the Pacific Ocean to the west.", "../images/Chile.jpg", southAmerica, archIslands, archJuan);
        ...
        Country mozambique = new Country("Mozambique","Muzambhiki), is a country located in Southeastern Africa bordered" +
                ...
                "Zimbabwe to the west","../images/Mozambique.jpg", africa, quirimbasIslands);
        ...
        Country newZealand = new Country("New Zealand","New Zealand is an island country in the southwestern" +
                ...
                " there are over 700 smaller islands","../images/New Zealand.jpg", oceania, aucklandIslands);
        Country france = new Country("France","France is a transcontinental country spanning Western Europe and " +
                "overseas regions and territories in the Americas and the Atlantic, Pacific and Indian Oceans.","../images/France.jpg", oceania, australIslands);
