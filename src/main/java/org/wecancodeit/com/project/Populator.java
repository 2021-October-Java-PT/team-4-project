...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Waterway bacuitBay = new Waterway("Bacuit Bay","Bacuit Bay is dotted with islands and islets, " +
                ...
                "occasional whale sharks. There are over 30 dive sites ranging in depth from six to more than thirty meters.","../images/BacuitBay.jpg");
        ...
        Island bornholm = new Island("Bornholm Falster Lolland", "The biggest islands in the Baltic Sea with the" +
                " most to do. Occupied by Denmark these islands are just a few from close to a hundred.","../images/Bornholm Island.jpg", balticSea);
        ...
        Island southernIslands = new Island("Southern Islands","Because of the many islands that Thailand" +
                "is made of, it might be advisable to take it in chunks.Some of these islands are" +
                "remote and uninhabited and others are settled.","../images/Southern Islands.jpg", gulfOfThailand);
        Island bacuitGroup = new Island("Bacuit Group of Islands","This group of Islands are fair weather " +
                "majority of the year. Crystal Clear waters with a remote feel without the lack of resources.","../images/Bacuit Islands.jpg", bacuitBay);
